		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?= base_url('assets/user/') ?>svg/undraw_join_of2w.svg" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="<?= base_url('Authh/register') ?>" method="post"> 
					<span class="login100-form-title">
						Daftar
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Isi Nama">
					...
					<div class="wrap-input100 validate-input" data-validate = "Isi Email dengan Valid: ex@abc.xyz">
					...
					<div class="wrap-input100 validate-input" data-validate = "Isi Konfirmasi Password">
					...
					<div class="text-center p-t-115">
						<a class="txt2" href="<?= base_url('Authh'); ?>">
							Sudah Punya Akun
